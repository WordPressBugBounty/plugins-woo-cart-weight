...
class IntegrationData
{
    ...
    public function set_integration_name(string $integration_name) : \WCWeightVendor\Octolize\Blocks\IntegrationData
    {
    ...
    public function set_script_name(string $script_name) : \WCWeightVendor\Octolize\Blocks\IntegrationData
    {
    ...
    public function set_script_path(string $script_name) : \WCWeightVendor\Octolize\Blocks\IntegrationData
    {
