...
class TrackerInitializer implements HookableCollection
{
     ...
     */
    public static function create_from_plugin_info(\WCWeightVendor\WPDesk_Plugin_Info $plugin_info, ?ShouldDisplay $should_display = null, ?ReasonsFactory $reasons_factory = null)
    {
