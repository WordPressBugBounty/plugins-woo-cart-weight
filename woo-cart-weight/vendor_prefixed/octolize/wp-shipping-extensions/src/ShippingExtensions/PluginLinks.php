 ...
 * .
 */
class PluginLinks implements \WCWeightVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    {
        $extensions_link = \add_query_arg('page', \WCWeightVendor\Octolize\ShippingExtensions\Page::MENU_SLUG, \admin_url('admin.php'));
