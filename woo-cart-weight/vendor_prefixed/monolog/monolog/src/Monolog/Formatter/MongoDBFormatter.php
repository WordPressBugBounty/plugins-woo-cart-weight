 ...
 */
class MongoDBFormatter implements \WCWeightVendor\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \WCWeightVendor\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \WCWeightVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
