...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\WCWeightVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \WCWeightVendor\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \WCWeightVendor\Monolog\Logger
    {
