 ...
 */
class MercurialProcessor implements \WCWeightVendor\Monolog\Processor\ProcessorInterface
{
    /** @var Level */
    private $level;
     ...
     */
    public function __construct($level = \WCWeightVendor\Monolog\Logger::DEBUG)
    {
