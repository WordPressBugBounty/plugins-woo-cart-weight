 ...
 */
class IntrospectionProcessor implements \WCWeightVendor\Monolog\Processor\ProcessorInterface
{
    /** @var int */
    private $level;
    /** @var string[] */
     ...
     */
    public function __construct($level = \WCWeightVendor\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \WCWeightVendor\Monolog\Logger::toMonologLevel($level);
