 ...
 */
class RedisPubSubHandler extends \WCWeightVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \WCWeightVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
