 ...
 */
class RotatingFileHandler extends \WCWeightVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \WCWeightVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \WCWeightVendor\Monolog\Utils::canonicalizePath($filename);
