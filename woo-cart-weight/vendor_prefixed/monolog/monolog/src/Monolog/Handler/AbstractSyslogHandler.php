 ...
 */
abstract class AbstractSyslogHandler extends \WCWeightVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var int */
    protected $facility;
    /**
     ...
     */
    protected $logLevels = [\WCWeightVendor\Monolog\Logger::DEBUG => \LOG_DEBUG, \WCWeightVendor\Monolog\Logger::INFO => \LOG_INFO, \WCWeightVendor\Monolog\Logger::NOTICE => \LOG_NOTICE, \WCWeightVendor\Monolog\Logger::WARNING => \LOG_WARNING, \WCWeightVendor\Monolog\Logger::ERROR => \LOG_ERR, \WCWeightVendor\Monolog\Logger::CRITICAL => \LOG_CRIT, \WCWeightVendor\Monolog\Logger::ALERT => \LOG_ALERT, \WCWeightVendor\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \WCWeightVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \WCWeightVendor\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
