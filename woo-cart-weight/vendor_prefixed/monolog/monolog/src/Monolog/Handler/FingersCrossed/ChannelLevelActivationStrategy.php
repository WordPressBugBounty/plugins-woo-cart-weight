 ...
 */
class ChannelLevelActivationStrategy implements \WCWeightVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \WCWeightVendor\Monolog\Logger::toMonologLevel($defaultActionLevel);
