 ...
 */
class CouchDBHandler extends \WCWeightVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var mixed[] */
    private $options;
    /**
     * @param mixed[] $options
     */
    public function __construct(array $options = [], $level = \WCWeightVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
