...
class WooCommerceMonologPlugin implements \WC_Logger_Interface
{
    ...
    public function __construct(\WCWeightVendor\Monolog\Logger $monolog, \WC_Logger_Interface $originalLogger)
    {
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::EMERGENCY, $message, $context);
    }
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::ALERT, $message, $context);
    }
    /**
     * Critical conditions.
     *
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::CRITICAL, $message, $context);
    }
    /**
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::ERROR, $message, $context);
    }
    /**
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::WARNING, $message, $context);
    }
    /**
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::NOTICE, $message, $context);
    }
    /**
     * Interesting events.
     *
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::INFO, $message, $context);
    }
    /**
    ...
    {
        $this->log(\WCWeightVendor\Psr\Log\LogLevel::DEBUG, $message, $context);
    }
}
