...
class Scripts
{
     ...
     */
    public function __construct(\WCWeightVendor\WPDesk\Tracker\Deactivation\PluginData $plugin_data, \WCWeightVendor\WPDesk\Tracker\Deactivation\ReasonsFactory $reasons_factory, $view_file = null)
    {
