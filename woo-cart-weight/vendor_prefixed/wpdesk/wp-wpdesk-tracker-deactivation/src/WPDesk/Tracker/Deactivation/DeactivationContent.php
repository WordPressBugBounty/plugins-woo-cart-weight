...
trait DeactivationContent
{
    ...
    private \WCWeightVendor\WPDesk\Tracker\Deactivation\ReasonsFactory $reasons_factory;
    /**
    ...
    public function getContent() : string
    {
        ...
        $ajax_action = \WCWeightVendor\WPDesk\Tracker\Deactivation\AjaxDeactivationDataHandler::AJAX_ACTION . $this->plugin_data->getPluginSlug();
