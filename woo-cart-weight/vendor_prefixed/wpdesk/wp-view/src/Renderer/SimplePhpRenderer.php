 ...
 */
class SimplePhpRenderer implements \WCWeightVendor\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\WCWeightVendor\WPDesk\View\Resolver\Resolver $resolver)
    {
